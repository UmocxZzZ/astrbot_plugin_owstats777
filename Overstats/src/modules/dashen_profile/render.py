...
def _load_fonts() -> Dict[str, Any]:
    return {
        ...
        "font_num": _load_font("GrotaRoundedExtraBold.otf", 30),
        "font_num_small": _load_font("GrotaRoundedExtraBold.otf", 18),
        "font_num_medium": _load_font("GrotaRoundedExtraBold.otf", 24),
        "font_num_large": _load_font("GrotaRoundedExtraBold.otf", 40),
        "font_num_huge": _load_font("GrotaRoundedExtraBold.otf", 72),
        "font_rank_tier": _load_font("GrotaRoundedExtraBold.otf", 88),
        "font_rank_tier_small": _load_font("GrotaRoundedExtraBold.otf", 52),
        "font_rank_tier_recent": _load_font("GrotaRoundedExtraBold.otf", 64),
        "font_rank_overlay_num": _load_font("GrotaRoundedExtraBold.otf", 24),
    }
